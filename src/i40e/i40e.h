...
#define I40E_FLAG_NO_DCB_SUPPORT		BIT_ULL(44)
#define I40E_FLAG_USE_SET_LLDP_MIB		BIT_ULL(45)
#define I40E_FLAG_STOP_FW_LLDP			BIT_ULL(46)
#define I40E_FLAG_HAVE_10GBASET_PHY		BIT_ULL(47)
